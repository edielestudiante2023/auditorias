...
<head>
    ...
    <title><?= esc($title ?? 'Crear Consultor') ?> | Auditorías</title>
...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0"><i class="bi bi-person-badge"></i> <?= esc($title ?? 'Crear Consultor') ?></h4>
        ...
        <div class="card-body">
            <form action="<?= esc($form_action) ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?= isset($errors['telefono']) ? 'is-invalid' : '' ?>" id="telefono" name="telefono" value="<?= esc(old('telefono')) ?>" maxlength="50">
